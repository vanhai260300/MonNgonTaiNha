...
$router->add('/DoAn1/public/verifi', ['controller' => 'RegisterController', 'action' => 'pageVerification']);
$router->add('/DoAn1/public/verifi/{vkey:\S+}', ['controller' => 'RegisterController', 'action' => 'xacThucEmail']);
