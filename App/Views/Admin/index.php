...
<html lang="en">
    <head>
        ...
        <link href="/DoAn1/public/asset_admin/css/styles.css?v=1.7" rel="stylesheet" />
    </head>
    ...
    <?php require_once '../App/Views/Admin/adminBlock/header.php'; ?>
        ...
        <script src="/DoAn1/public/asset_admin/chart-area-demo.js"></script>
        <script src="/DoAn1/public/asset_admin/chart-bar-demo.js"></script>
        ...
        <script src="/DoAn1/public/asset_admin/js/main.js?v=1.7"></script>
    </body>
</html>
