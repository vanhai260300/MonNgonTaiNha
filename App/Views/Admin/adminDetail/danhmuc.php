                    ...
                    <tbody>
                        <?php foreach ($args['listDanhMuc'] as $key => $value) { ?>
                            <tr id="row_<?php echo $value['IDDanhMuc']; ?>">
                                ...
                                <td class="actions">
                                    <a href="" title="Sửa" onclick="updateAdmin(<?php echo $value['IDDanhMuc']; ?>);" data-bs-toggle="modal" class="button" id="button_<?php echo $value['IDDanhMuc']; ?>" data-bs-target="#myModalUpdate"><i class="fas fa-edit"></i></a>
                                    <a class="bt-delete-red" onclick="deleteADmin(<?php echo $value['IDDanhMuc']; ?>)" title="Xóa"><i class="fas fa-trash-alt"></i></a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
