<!-- banner part starts -->
<section class="hero bg-image" data-image-src="/DoAn1/public/image/img/main.jpeg" style="background: url(&quot;/DoAn1/public/image/img/main.jpeg&quot;) center center / cover no-repeat;">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                    <div class="food-item-wrap">
                        <div class="figure-wrap bg-image" data-image-src="/DoAn1/public/image/Res_img/dishes/5ad7582e2ec9c.jpg" style="background: url(&quot;/DoAn1/public/image/Res_img/dishes/5ad7582e2ec9c.jpg&quot;) center center / cover no-repeat;">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                    <div class="food-item-wrap">
                        <div class="figure-wrap bg-image" data-image-src="/DoAn1/public/image/Res_img/dishes/5ad7590d9702b.jpg" style="background: url(&quot;/DoAn1/public/image/Res_img/dishes/5ad7590d9702b.jpg&quot;) center center / cover no-repeat;">
                            <div class="distance"><i class="fa fa-pin"></i>1240m</div>
                            <div class="rating pull-left"> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star-o"></i> </div>
                            <div class="review pull-right"><a href="#">198 reviews</a> </div>
                        </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                    <div class="food-item-wrap">
                        <div class="figure-wrap bg-image" data-image-src="/DoAn1/public/image/Res_img/dishes/5ad7597aa0479.jpg" style="background: url(&quot;/DoAn1/public/image/Res_img/dishes/5ad7597aa0479.jpg&quot;) center center / cover no-repeat;">
                            <div class="distance"><i class="fa fa-pin"></i>1240m</div>
                            <div class="rating pull-left"> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star-o"></i> </div>
                            <div class="review pull-right"><a href="#">198 reviews</a> </div>
                        </div>
        ...
        <div class="container">
                ...
                <div class="row how-it-works-solution">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                        <div class="step step-3">
                            ...
                            <h3>Thanh toán và giao hàng tận nơi</h3>
            ...
            <div class="row">
                <div class="col-sm-12 text-center">
                    <p class="pay-info">Thanh toán khi nhận hàng hoặc thanh toán trực tuyến</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="featured-restaurants">
        <div class="container">
                    ...
                    <div class="restaurants-filter pull-right">
                        <nav class="primary pull-left">
                            <ul>
                                ...
                                <li><a href="#" data-filter=".grill"> grill</a> </li>
                                <li><a href="#" data-filter=".pizza"> pizza</a> </li>
                                <li><a href="#" data-filter=".pasta"> pasta</a> </li>
                                <li><a href="#" data-filter=".thaifood"> thaifood</a> </li>
            ...
            <div class="row">
                <div class="restaurant-listing" style="position: relative; height: 498px;">


                    <div class="col-xs-12 col-sm-12 col-md-6 single-restaurant all grill" style="position: absolute; left: 0px; top: 0px;">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 single-restaurant all grill" style="position: absolute; left: 620px; top: 0px;">
                        <div class="restaurant-wrap">
                            <div class="row">
                                <div class="col-xs-12 col-sm-3 col-md-12 col-lg-3 text-xs-center">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 single-restaurant all pizza" style="position: absolute; left: 0px; top: 150px;">
                        <div class="restaurant-wrap">
                            <div class="row">
                                <div class="col-xs-12 col-sm-3 col-md-12 col-lg-3 text-xs-center">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 single-restaurant all pasta" style="position: absolute; left: 620px; top: 174px;">
                        <div class="restaurant-wrap">
                            <div class="row">
                                <div class="col-xs-12 col-sm-3 col-md-12 col-lg-3 text-xs-center">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 single-restaurant all thaifood" style="position: absolute; left: 0px; top: 324px;">
                        <div class="restaurant-wrap">
                            <div class="row">
                                <div class="col-xs-12 col-sm-3 col-md-12 col-lg-3 text-xs-center">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 single-restaurant all fish" style="position: absolute; left: 620px; top: 324px;">
                        <div class="restaurant-wrap">
                            <div class="row">
                                <div class="col-xs-12 col-sm-3 col-md-12 col-lg-3 text-xs-center">
