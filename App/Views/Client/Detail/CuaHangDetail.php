...
<div class="top-links">
        ...
        <section class="inner-page-hero bg-image" data-image-src="/DoAn1/public/image/img/dish.jpeg"
            style="background: url(&quot;/DoAn1/public/image/img/dish.jpeg&quot;) center center / cover no-repeat;">
            <div class="profile">
                <div class="container">
                    <div class="row">
            ...
            <div class="row">
                    ...
                    <div class="widget widget-cart">
                        ...
                        <div class="widget-body">
                            <div class="price-wrap text-xs-center">
                                ...
                                <p>Free Shipping</p>
                                <a href="checkout.php?res_id=48&amp;action=check"
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 col-lg-6">
                    ...
                    <div class="menu-widget" id="2">
                        <div class="widget-heading">
                            <h3 class="widget-title text-dark">
                                Món Ăn phổ biến của cửa hàng! <a class="btn btn-link pull-right"
                            ...
                            <div class="food-item">
                                <div class="row">
                                        ...
                                        <form method="post" action="dishes.php?res_id=48&amp;action=add&amp;id=11">
                                            <div class="rest-logo pull-left">
                                                <a class="restaurant-logo pull-left" href="#"><img
                                                        src="/DoAn1/public/image/Res_img/dishes/<?php echo $value['Anh1']; ?>"
                                                        alt="Food logo"></a>
                                            </div>
                                            <!-- end:Logo -->
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-lg-4 pull-right item-cart-info">
                                        ...
                                        <input  type="text" name="quantity" style="margin-left:30px;"
                                            value="1" size="2">
